...
-- A full Crystal battle sprite at one cell wide reads undersized in VASC's
-- widescreen MAP camera (especially against 32px tree masses). 24 world
-- pixels keeps the species' own relative artwork sizes, remains below a
-- two-cell footprint and restores the stronger Gen-1 battle presence.
BattleBillboard.FULL_W = 32
