-- Elite Four / Agatha. Compact creation for PANDY.
...
local T={
 ...
 family="tower",
 kind="ghost",
 subtitle="VIOLETA · PEDRA ANTIGA E CIANO",
 tiles={{0.29,0.21,0.46},{0.43,0.3,0.58},{0.34,0.25,0.5},{0.47,0.34,0.61}},
 grout={0.12,0.14,0.25},
 moss={0.24,0.39,0.2},
 court={0.78,0.78,0.88},
 courtGrid={0.71,0.71,0.83},
 courtEdge={0.18,0.18,0.29},
 courtLine={0.24,0.23,0.28},
 markFront={0.76,0.69,0.4},
 markBack={0.43,0.34,0.52},
 wall={0.22,0.44,0.5},
 cap={0.26,0.16,0.48},
 trim={0.25,0.28,0.45},
 windowFrame={0.13,0.22,0.35},
 window={0.49,0.77,0.82},
 columnDark={0.075,0.105,0.22},
 columnLight={0.18,0.25,0.41},
 columnTones={{0.1,0.14,0.27}},
 doorFrame={0.18,0.13,0.29},
 door={0.61,0.61,0.71},
 badgeShadow={0.14,0.08,0.25},
 badgeMetal={0.37,0.29,0.6},
 badgeLight={0.72,0.65,0.89},
 gem={0.18,0.79,0.89},
 gemLight={0.78,0.98,1},
 gemShade={0.12,0.41,0.59},
 ballTop={0.39,0.17,0.62},
 ballBottom={0.72,0.75,0.87}
}
