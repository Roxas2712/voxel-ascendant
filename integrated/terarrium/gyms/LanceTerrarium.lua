-- Elite Four / Lance. Compact creation for PANDY.
...
local T={
 ...
 family="gym",
 kind="dragon",
 subtitle="ESMERALDA · MARFIM E VERMELHO",
 tiles={{0.1,0.37,0.34},{0.17,0.47,0.4},{0.1,0.42,0.38},{0.22,0.51,0.43}},
 grout={0.065,0.23,0.26},
 floorHighlight={0.25,0.55,0.45},
 court={0.56,0.77,0.62},
 courtGrid={0.64,0.82,0.69},
 courtEdge={0.12,0.33,0.31},
 courtLine={0.92,0.91,0.75},
 markFront={0.2,0.65,0.77},
 markBack={0.94,0.36,0.16},
 wall={0.83,0.72,0.17},
 cap={0.67,0.1,0.12},
 trim={0.18,0.37,0.3},
 windowFrame={0.19,0.34,0.34},
 window={0.73,0.94,0.89},
 columnDark={0.18,0.3,0.25},
 columnLight={0.94,0.93,0.85},
 columnTones={{0.74,0.79,0.72},{0.85,0.87,0.8},{0.67,0.73,0.66}},
 doorFrame={0.13,0.36,0.3},
 door={0.82,0.84,0.74},
 badgeShadow={0.27,0.19,0.045},
 badgeMetal={0.76,0.58,0.14},
 badgeLight={1,0.88,0.45},
 gem={0.075,0.66,0.4},
 gemLight={0.7,0.97,0.76},
 gemShade={0.035,0.33,0.24},
 ballTop={0.83,0.08,0.14},
 ballBottom={0.94,0.93,0.81}
}
