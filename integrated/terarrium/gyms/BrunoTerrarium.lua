-- Elite Four / Bruno. Compact creation for PANDY.
...
local T={
 ...
 family="cave",
 kind="rock",
 subtitle="TERRACOTA · PEDRA E AZUL",
 tiles={{0.74,0.61,0.4},{0.91,0.82,0.63},{0.83,0.72,0.51},{0.95,0.88,0.7}},
 grout={0.48,0.36,0.24},
 crack={0.51,0.39,0.27},
 court={0.24,0.52,0.76},
 courtGrid={0.35,0.62,0.82},
 courtEdge={0.61,0.15,0.14},
 courtLine={0.28,0.24,0.25},
 markFront={0.9,0.63,0.4},
 markBack={0.88,0.24,0.12},
 wall={0.76,0.35,0.23},
 cap={0.5,0.23,0.17},
 trim={0.6,0.23,0.16},
 windowFrame={0.28,0.4,0.49},
 window={0.69,0.91,0.94},
 columnDark={0.42,0.22,0.13},
 columnLight={0.74,0.44,0.27},
 columnTones={{0.52,0.27,0.15},{0.63,0.34,0.2},{0.69,0.39,0.23}},
 doorFrame={0.58,0.19,0.16},
 door={0.83,0.79,0.65},
 badgeShadow={0.35,0.16,0.06},
 badgeMetal={0.75,0.4,0.13},
 badgeLight={1,0.8,0.39},
 gem={0.2,0.53,0.8},
 gemLight={0.74,0.91,1},
 gemShade={0.08,0.29,0.54},
 ballTop={0.87,0.28,0.1},
 ballBottom={0.96,0.84,0.62}
}
