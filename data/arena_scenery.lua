...
add({ "CELADON_GYM" }, "arena_gym-celadon.compact.png", false, 1.8)
add({ "CERULEAN_GYM" }, "arena_gym-cerulean.compact.png", false, 1.8)
add({ "CINNABAR_GYM" }, "arena_gym-cinnabar.compact.png", false, 1.8)
add({ "FIGHTING_DOJO" }, "arena_gym-fighting-dojo.compact.png", false, 1.8)
add({ "FUCHSIA_GYM" }, "arena_gym-fuchsia.compact.png", false, 1.8)
add({ "PEWTER_GYM" }, "arena_gym-pewter.compact.png", false, 1.8)
add({ "SAFFRON_GYM" }, "arena_gym-saffron.compact.png", false, 1.8)
add({ "VERMILION_GYM" }, "arena_gym-vermilion.compact.png", false, 1.8)
add({ "VIRIDIAN_GYM" }, "arena_gym-viridian.compact.png", false, 1.8)
